		...
		<fieldset>
			...
			<div id="login_form_content" style="display:none;">
                ...
                <ul class="wrapper_block">
                    <li>
                        <label class="required" for="login_email"><em>*</em>{l s='E-mail address'}</label>
                        <div class="input-box">
                            <input type="text" id="login_email" name="email" class="input-text" />
                        </div>
                    </li>
                    <li>
                        <label class="required" for="login_passwd"><em>*</em>{l s='Password'}</label>
                        <div class="input-box">
                            <input type="password" id="login_passwd" name="login_passwd" class="input-text" />
                        </div>
                    </li>
                </ul>
	...
	<form action="javascript:;" method="post" id="new_account_form" class="std" autocomplete="on" autofill="on">
		<fieldset>
			...
			<div id="opc_account_form">
				...
				<p class="checkbox">
                    <input type="checkbox" name="invoice_address" id="invoice_address"{if (isset($smarty.post.invoice_address) && $smarty.post.invoice_address) || (isset($guestInformations.invoice_address) && $guestInformations.invoice_address)} checked="checked"{/if} autocomplete="off"/>
